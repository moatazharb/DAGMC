...
/// This mode is used for error propagation from mesh-based sources via sampling.
...
namespace pyne {
  ...
  /// \param mode The sampling mode: 0 = analog, 1 = uniform, 2 = user-specified, 3 = user-error
  ...
  /// Problem modes
  /// UBIASED > user biased source density is provided
  /// UWEIGHT > user particles weights are provided
